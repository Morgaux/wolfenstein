...
${WOLF_3D:%=test_%_help_message}:
	...
	@${INDENT} "This test ensures that the ${WOLF_3D} project as a whole "
	@${INDENT} "can be build and run, it leaves the finer details and"
	@${INDENT} "subtleties of the project to the other test cases."
